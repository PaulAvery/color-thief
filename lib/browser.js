...
},{"canvas":5,"fs":1}],4:[function(require,module,exports){
'use strict';
...
var ColorThief = (function () {
   ...
   * */
		...
		value: function getColor(sourceImage) {
			var quality = arguments[1] === undefined ? 10 : arguments[1];
   ...
   *
   */
		value: function getPalette(sourceImage) {
			var colorCount = arguments[1] === undefined ? 10 : arguments[1];
			var quality = arguments[2] === undefined ? 10 : arguments[2];
			...
			var pixelArray = [];
			for (var i = 0, offset = undefined, r = undefined, g = undefined, b = undefined, a = undefined; i < pixelCount; i = i + quality) {
				offset = i * 4;
				r = pixels[offset + 0];
				g = pixels[offset + 1];
				b = pixels[offset + 2];
...
},{"./CanvasImage":3,"quantize":2}],5:[function(require,module,exports){
'use strict';
...
var _ColorThief = require('../ColorThief');

var _ColorThief2 = _interopRequireDefault(_ColorThief);

window.ColorThief = _ColorThief2['default'];
